...
{\small * indicates equal contribution.}
	\vspace{14pt}
\begin{enumerate}
    \item \textbf{Jeongwhan Choi}*, Jongwoo Kim*, Woosung Kang, Noseong Park, ``Learning Posterior Predictive Distributions for Node Classification from Synthetic Graph Priors'', International Conference on Learning Representations (\textit{ICLR}), 2026. [\href{https://openreview.net/forum?id=qkBBHixPow}{OpenReview}]
    \item \textbf{Jeongwhan Choi}, Seungjun Park, Sumin Park, Sung-Bae Cho, Noseong Park ``Are Graph Transformers Necessary? Efficient Long-Range Message Passing with Fractal Nodes in MPNNs'', AAAI Conference on Artificial Intelligence (\textit{AAAI}), 2026. [\RED{Oral Presentation}][\href{http://arxiv.org/abs/2511.13010}{arXiv}]
    \item Youn-Yeol Yu*, \textbf{Jeongwhan Choi}*, Jaehyeon Park, Kookjin Lee, Noseong Park, ``PIORF: Physics-Informed Ollivier-Ricci Flow for Long–Range Interactions in Mesh Graph Neural Networks'', International Conference on Learning Representations (ICLR), 2025. [\href{https://openreview.net/forum?id=qkBBHixPow}{Paper}]
    \item \textbf{Jeongwhan Choi}*, Hyowon Wi*, Jayoung Kim, Yehjin Shin, Kookjin Lee, Nathaniel Trask, Noseong Park, ``Graph Convolutions Enrich the Self-Attention in Transformers!'', Conference on Neural Information Processing Systems (\textit{NeurIPS}), 2024. [\href{https://proceedings.neurips.cc/paper_files/paper/2024/hash/5eceb48c3bc8b5d936c05ff8e2ece65e-Abstract-Conference.html}{Paper}]
    \item \textbf{Jeongwhan Choi}, Sumin Park, Hyowon Wi, Sung-Bae Cho, Noseong Park, ``PANDA: Expanded Width-Aware Message Passing Beyond Rewiring'', International Conference on Machine Learning (\textit{ICML}), 2024. [\href{https://proceedings.mlr.press/v235/choi24f.html}{Paper}]
    \item Yehjin Shin*, \textbf{Jeongwhan Choi}*, Hyowon Wi, Noseong Park, ``An Attentive Inductive Bias for Sequential Recommendation beyond the Self-Attention'', AAAI Conference on Artificial Intelligence (\textit{AAAI}), 2024. [\href{https://ojs.aaai.org/index.php/AAAI/article/view/28747}{Paper}]
    \item \textbf{Jeongwhan Choi}, Seoyoung Hong, Noseong Park, Sung-Bae Cho, ``GREAD: Graph Reaction-Diffusion Networks'', International Conference on Machine Learning (\textit{ICML}), 2023. [\href{http://proceedings.mlr.press/v202/choi23a}{Paper}][\href{https://github.com/jeongwhanchoi/GREAD}{Code}]
    ...
    \item \textbf{Jeongwhan Choi} and Noseong Park, ``Graph Neural Rough Differential Equations for Traffic Forecasting'', ACM Transactions on Intelligent Systems and Technology (\textit{TIST}), 2023. [\href{https://dl.acm.org/doi/abs/10.1145/3604808}{Paper}][\RED{IF=10.489}]
    ...
    \item \textbf{Jeongwhan Choi}, Jinsung Jeon, and Noseong Park, ``LT-OCF: Learnable-Time ODE-based Collaborative Filtering'', ACM International Conference on Information and Knowledge Management (\textit{CIKM}), 2021. [\href{https://arxiv.org/pdf/2108.06208.pdf}{Paper}] [\href{https://github.com/jeongwhanchoi/LT-OCF}{Code}] 
\end{enumerate}
\end{body}
\vspace{14pt}
...
\lineover
\begin{enumerate}
    \item \textbf{Jeongwhan Choi}, Jongwoo Kim, Woosung Kang, Noseong Park, ``Learning Posterior Predictive Distributions for Node Classification from Synthetic Graph Priors'', International Conference on Learning Representations (ICLR), 2026. [\href{https://openreview.net/forum?id=qkBBHixPow}{OpenReview}]
    \item \textbf{Jeongwhan Choi}, Seungjun Park, Sumin Park, Sung-Bae Cho, Noseong Park ``Are Graph Transformers Necessary? Efficient Long-Range Message Passing with Fractal Nodes in MPNNs'', AAAI Conference on Artificial Intelligence (\textit{AAAI}), 2026. [\RED{Oral Presentation}][\RED{Acceptance Rate 17.6\% (4,167/23,680)}] 
    ...
    \item Youn-Yeol Yu*, \textbf{Jeongwhan Choi}*, Jaehyeon Park, Kookjin Lee, and Noseong Park,``PIORF: Physics-Informed Ollivier-Ricci Flow for Long–Range Interactions in Mesh Graph Neural Networks'', International Conference on Learning Representations (ICLR), 2025. [\RED{Acceptance Rate 32.08\%}] [\href{https://openreview.net/forum?id=qkBBHixPow}{Paper}]
    \item Seonkyu Lim*, \textbf{Jeongwhan Choi}*, Jaehoon Lee, Noseong Park,``FrAug: Enhanced Fraud Detection in Interbank Transfers via Augmented Account Features'', IEEE BigComp, 2025.
    \item Chaejeong Lee*, \textbf{Jeongwhan Choi}*, Hyowon Wi,  Sung-Bae Cho, and Noseong Park, ``SCONE: A Novel Stochastic Sampling to Generate Contrastive Views and Hard Negative Samples for Recommendation'', ACM International Conference on Web Search and Data Mining (WSDM), 2025. [\RED{Acceptance rate: 17.3\% (106/615)}]
    \item \textbf{Jeongwhan Choi}*, Hyowon Wi*, Jayoung Kim, Yehjin Shin, Kookjin Lee, Nathaniel Trask, Noseong Park, ``Graph Convolutions Enrich the Self-Attention in Transformers!'', Conference on Neural Information Processing Systems (\textit{NeurIPS}), 2024. [\RED{Paper Acceptance rate: 25.8\%}][\href{https://arxiv.org/abs/2312.04234}{arXiv}]
    ...
    \item Yehjin Shin*, \textbf{Jeongwhan Choi}*, Hyowon Wi, Noseong Park, ``An Attentive Inductive Bias for Sequential Recommendation beyond the Self-Attention'', AAAI Conference on Artificial Intelligence (\textit{AAAI}), 2024. [\RED{Acceptance Rate 23.75\% (2342/12100)}] [\href{https://arxiv.org/abs/2312.10325}{arXiv}]
...
\begin{enumerate}
    ...
    \item Seonkyu Lim*, \textbf{Jeongwhan Choi}*, Noseong Park,``FraudCenGCL: Enhancing Fraud Detection via Dual-View Graph Contrastive Learning with Account Centrality Features'', Social Impact: Bridging Innovations in Finance, Social Media, and Crime Prevention Workshop at AAAI 2025.
    \item Seonkyu Lim*, \textbf{Jeongwhan Choi}*, Jaehoon Lee, Noseong Park,``FrAug: Enhanced Fraud Detection in Interbank Transfers via Augmented Account Features'', AI4TS Workshop at AAAI 2025.
...
\lineover
\begin{enumerate}
    \item \textbf{Jeongwhan Choi}, Woosung Kang, Minseo Kim, Jongwoo Kim, Noseong Park, ``Can TabPFN Compete with GNNs for Node Classification via Graph Tabularization?'', arXiv preprint arXiv: Arxiv-2512.08798, 2025. [\href{https://arxiv.org/abs/2512.08798}{arXiv}]
...
\begin{body}
   ...
   \textsc{Reviewer or Program Committee Member for Conference}
    ...
    \begin{itemize}
        ...
        \item Expert Systems With Applications (ESWA) — 10 reviews in 2025
