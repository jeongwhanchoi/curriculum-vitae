...
\contact{Jeongwhan Choi}{\href{mailto:email@address.com}{jeongwhan.choi@yonsei.ac.kr}}{\href{https://jeongwhanchoi.me}{Homepage Link}}{\href{https://scholar.google.com/citations?user=3MNElkYAAAAJ&hl=en}{Google Scholar}}
...
\award{Invited talk on Top-conference session,  Korea Computer Congress (KCC 2022)}{Jul 2022}
	\begin{itemize} \itemsep -0pt  % reduce space between items
		\item \href{https://www.dropbox.com/s/22d9d92ns8uv9qw/AAAI22_KCC22.pdf?dl=0}{slide link}
  	\end{itemize}
\award{Graph-based Collaborative Filtering and Neural ODEs, 한국인공지능학회(KAIA) | LG AI Research}{Nov 2021}
	\begin{itemize} \itemsep -0pt  % reduce space between items
		\item This talk is part of a tutorial called "Deep Learning Inspired by Differential Equation".
        \item \href{https://www.dropbox.com/s/1xn8xhd6llmhblz/%5BKAIA2021%5DTutorial-LT-OCF.pdf?dl=0}{slide link}
  	\end{itemize}
\end{body}
